...
(1, '股票', 'STOCKS', '国内外股票、基金', '📈', '#3B82F6', 4, TRUE),
(1, '国内股票', 'STOCKS', 'A股市场股票', '🇨🇳', '#3B82F6', 5, TRUE),
(1, '海外股票', 'STOCKS', '美股、港股等', '🌍', '#3B82F6', 6, TRUE),
(1, '基金', 'STOCKS', '股票基金、混合基金等', '📊', '#3B82F6', 7, TRUE),
(1, '退休基金', 'RETIREMENT_FUND', '养老保险、401k、IRA等', '🎯', '#8B5CF6', 8, TRUE),
(1, '401k', 'RETIREMENT_FUND', '美国401k退休账户', '🇺🇸', '#8B5CF6', 9, TRUE),
(1, 'IRA', 'RETIREMENT_FUND', '个人退休账户', '🏦', '#8B5CF6', 10, TRUE),
(1, '养老保险', 'RETIREMENT_FUND', '社保、商业养老保险', '🛡️', '#8B5CF6', 11, TRUE),
(1, '保险', 'INSURANCE', '人寿保险、年金保险现金价值', '🛡️', '#F59E0B', 12, TRUE),
(1, '人寿保险', 'INSURANCE', '人寿保险现金价值', '👨‍👩‍👧', '#F59E0B', 13, TRUE),
(1, '年金保险', 'INSURANCE', '年金保险账户', '💍', '#F59E0B', 14, TRUE),
(1, '房产', 'REAL_ESTATE', '自住房产、投资房产', '🏠', '#EF4444', 15, TRUE),
(1, '自住房产', 'REAL_ESTATE', '主要居住房产', '🏡', '#EF4444', 16, TRUE),
(1, '投资房产', 'REAL_ESTATE', '出租或投资房产', '🏢', '#EF4444', 17, TRUE),
(1, '数字货币', 'CRYPTOCURRENCY', '比特币、以太坊等', '₿', '#F97316', 18, TRUE),
(1, '比特币', 'CRYPTOCURRENCY', 'Bitcoin', '₿', '#F97316', 19, TRUE),
(1, '以太坊', 'CRYPTOCURRENCY', 'Ethereum', 'Ξ', '#F97316', 20, TRUE);
